package in.sujeeth.infosysinternproject.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/request/**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN", "USER", "ADMIN", "ROLE_SUPPLIER", "SUPPLIER")
                .requestMatchers(HttpMethod.POST, "/api/request/status").hasAnyAuthority("ROLE_ADMIN", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/request/**").hasAnyAuthority("ROLE_ADMIN", "ADMIN")
